            ...
            {faq.map((q, i) => {
              return (
                <Disclosure key={i} as="div" className={`${i > 0 ? "mt-5" : ""} w-full`}>
                  {({ open }) => (
                    <>
                      <DisclosureButton className="mb-2 w-full rounded-lg bg-amber-100 px-4 py-2 text-left text-sm font-medium text-amber-900 hover:bg-amber-200 focus:outline-none focus-visible:ring focus-visible:ring-amber-500 focus-visible:ring-opacity-75">
                        <span>
