        ...
        <div className="bg-[#755938] rounded-none xl:rounded-2xl mt-0 xl:mt-4 overflow-hidden">
          <div className="flex flex-col md:flex-row h-full items-center justify-between px-6 lg:px-8 py-12 bg-gradient-to-r from-[#664C32] to-[#755938]">
            <div className="w-full md:w-1/2 max-w-[464px] md:max-w-none">
              <h1 className={`${copperplateFont.className} font-bold text-3xl sm:text-4xl`}>Tenez-vous au courant</h1>
              <p className="mt-6">
                Nous communiquons majoritairement sur Discord et Twitter. N&apos;hésitez pas à vous tenir au courant des futures Alpha/Beta, à poser
                des questions à l&apos;équipe ou participer dans la communauté.
              </p>
          ...
          <div className="flex flex-col md:flex-row h-full items-center justify-between px-6 lg:px-8 py-12 bg-gradient-to-l from-[#664C32] to-[#755938]">
            ...
            <div className="w-full md:w-1/2 max-w-[464px] md:max-w-none">
              <h1 className={`${copperplateFont.className} font-bold text-3xl sm:text-4xl`}>Rejoindre l&apos;aventure</h1>
              <p className="mt-6">
                Dés qu&apos;une période de test est annoncée (Alpha ou Beta), vous aurez la possibilité de vous connecter en jeu en passant par notre
                Launcher.
                <br />
